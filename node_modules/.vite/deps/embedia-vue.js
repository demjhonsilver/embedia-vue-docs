...
// node_modules/embedia-vue/dist/index.es.js
var I = 1;
var T = (e) => {
...
var S = (e, t, o) => {
  const i = e.width || 640, n = e.height || 360, l = e.controls !== void 0 ? e.controls : true, r = e.autoplay === true, c = e.loop === "true", a = e.fullscreen === true, d = V(e.videoUrl), s = document.createElement("div");
  ...
  return m.src = "https://player.vimeo.com/api/player.js", m.async = true, m.onload = () => {
    new window.Vimeo.Player(s, {
      ...
      if (console.log("Vimeo player is ready"), a === false) {
...
var M = (e, t, o) => {
  ...
  try {
    ...
    const c = document.createElement("script");
    c.src = "https://platform.twitter.com/widgets.js", c.charset = "utf-8", c.async = true, c.addEventListener("load", () => {
...
var N = (e, t, o) => {
  ...
  try {
    ...
    r.className = `twitter-tweet ${o}`, r.innerHTML = `
      ...
      `, t.appendChild(r);
    const c = document.createElement("script");
    c.src = "https://platform.x.com/widgets.js", c.charset = "utf-8", c.async = true, c.addEventListener("load", () => {
...
var R = (e, t, o) => {
  ...
  r.open("GET", `https://www.tiktok.com/oembed?url=${encodeURIComponent(i)}`, true), r.onload = function() {
...
var B = (e) => (pushScopeId("data-v-1b3c3886"), e = e(), popScopeId(), e);
var H = B(() => createBaseVNode("div", { class: "video-content" }, null, -1));
var W = [
  H
];
function z(e, t, o, i, n, l) {
  return openBlock(), createElementBlock("div", {
    class: normalizeClass([o.cssname, "responsive-container"]),
    style: normalizeStyle({ "--aspect-ratio": i.aspectRatio, width: "auto", maxWidth: "100%" })
  }, W, 6);
}
var Y = A(j, [["render", z], ["__scopeId", "data-v-1b3c3886"]]);
export {
  Y as EmbediaVue
};
//# sourceMappingURL=embedia-vue.js.map
